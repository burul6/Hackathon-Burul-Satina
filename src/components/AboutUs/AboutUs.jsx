          ...
          >
            ...
            <section className='our-team-section' style={{marginBottom:"0px"}}>
                ...
                <div style={{display:"flex"}}> 
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-1.jpg" alt="" />
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-2.jpg" alt="" />
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-3.jpg" alt="" />
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-4.jpg" alt="" />
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-5.jpg" alt="" />
                    <img style={{width:"214px"}} src="http://unionagency.one/delice/img/about/food-image-6.jpg" alt="" />
                </div>
            </section>
        </div>
    );
