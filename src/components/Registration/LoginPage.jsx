    ...
    return (
        <div style={{textAlign:"center"}}>
            <div className='register' style={{width:"400px", textAlign:"center", marginLeft:"400px"}}>
                <div style={{fontSize:"45px", fontWeight:"600", marginBottom:"25px"}}>LOG IN</div>
                <div style={{width:"100%"}}>
                <input style={{border:"1px solid rgba(209,209,209,0.7)", height:"44px", width:"100%", marginBottom:"15px", padding:"0 20px"}} type="text" placeholder='Your email'/>
                </div>
                <div style={{width:"100%"}}>
                <input  style={{border:"1px solid rgba(209,209,209,0.7)", height:"44px", width:"100%", padding:"0 20px", marginBottom:"15px"}} type="text" placeholder='Enter password' required/>
                </div>
